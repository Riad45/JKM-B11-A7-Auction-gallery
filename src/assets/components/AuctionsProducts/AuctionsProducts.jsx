...
const AuctionsProducts = () => {
  ...
  const handleCancelBtn = (product) => {
    const newBidItems = bidItems.filter((item) => item.id != product.id);
    setBidItems(newBidItems);

    toast("Item has been removed from the bidlist");
  };
